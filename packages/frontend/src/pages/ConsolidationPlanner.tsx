  ...
  return (
    <div className="page" style={{ maxWidth: 680 }}>
      ...
      <div className="alert alert-info mb-6">
        <span>ℹ</span>
        Consolidating UTXOs when fees are low reduces the cost of future spends. This tool will group all
        UTXOs below your chosen threshold into a single output.{' '}
        <strong>It does not sign or broadcast.</strong>
      </div>
