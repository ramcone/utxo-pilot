...
try {
  ...
  walletId = result.lastInsertRowid as number;
  if (result.changes === 0) {
    walletId = (db.prepare("SELECT id FROM wallets WHERE name = 'Demo Wallet (testnet sample)'").get() as any).id;
  }
} catch (err) {
...
db.prepare("INSERT OR REPLACE INTO settings (key, value) VALUES (?, ?)").run(
  ...
  'xpub6CUGRUonZSQ4TWtTMmzXdrXDtypWKiKrhko4egpiMZbpiaQL2jkwSB1icqYh2cfDfVxdx4df189oijk3WkiGk4Q5TSVxsWbcBH7Xr4kpRba'
);

// Seed mock UTXOs
const now = Math.floor(Date.now() / 1000);
const mockUTXOs = [
  { txid: 'aaaa'.repeat(16), vout: 0, address: 'bc1qw508d6qejxtdg4y5r3zarvary0c5xw7kv8f3t4', amount: 5_000_000,  block_height: 840000, block_time: now - 86400 * 30 },
  { txid: 'bbbb'.repeat(16), vout: 1, address: 'bc1qrp33g0q5c5txsp9arysrx4k6zdkfs4nce4xj0gdcccefvpysxf3qccfmv3', amount: 1_230_000,  block_height: 841000, block_time: now - 86400 * 14 },
  { txid: 'cccc'.repeat(16), vout: 0, address: 'bc1q0c7y6x7kz0lj5gqq2dk90kl2nxzl04l9whnqcy', amount: 500_000,   block_height: 842000, block_time: now - 86400 * 7  },
  { txid: 'dddd'.repeat(16), vout: 0, address: 'bc1qa5wkgaew2dkv56kfvj49j0av5nml45x9ek9hz6', amount: 8_500,     block_height: 842500, block_time: now - 86400 * 3  },
  { txid: 'eeee'.repeat(16), vout: 2, address: 'bc1qcr8te4kr609gcawutmrza0j4xv80jy8z306fyu', amount: 3_200,     block_height: 843000, block_time: now - 86400 * 1  },
  ...
  { txid: 'a1b2'.repeat(16), vout: 0, address: 'bc1qh4nqnzxnh82cdy2n9qv7h54m02nk3wpnfyspq4', amount: 2_100_000, block_height: null,   block_time: null             }, // unconfirmed
];
